...
<body>
				...
				<div class="supportNewsView">
					...
					<div class="viewBtnList">
						<div style="display:flex;align-items:center;">
							...
							<button type="button" class="normalBtn" onclick="javascript:deleteNews();">삭 제</button>
						</div>						
	...
	$(document).ready(function(){        
		...
		getNewsDetail();   //게시글 상세내용 조회     
		
		var data = '';
		$.each( $('#newsForm').serializeArray(), function(key, val){
	...
	/** 게시판 - 상세 조회  */
    function getNewsDetail(boardno){	        
	 ...
	 /** 게시판 - 상세 조회  콜백 함수 */
    function getNewsDetailCallback(obj){
        console.log(obj);
        var str = "";	        
        if(obj != null){
    ...
    /** 게시판 - 삭제 콜백 함수 */
    function deleteNewsCallback(obj){	    
        if(obj != null){     	            
